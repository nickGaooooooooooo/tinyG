...
! function() {
    ...
    const e = e => {
        ...
        s = e => t => (e => {
            const t = typeof e;
            return null === e ? "null" : "object" === t && Array.isArray(e) ? "array" : "object" === t && (r = o = e, (n = String).prototype.isPrototypeOf(r) || (null === (s = o.constructor) || void 0 === s ? void 0 : s.name) === n.name) ? "string" : t;
            var r, o, n, s
        })(t) === e,
        a = e => t => typeof t === e,
        i = s("string"),
    ...
    const b = Array.prototype.indexOf,
        ...
        O = (e, t) => (e => {
            const t = [];
            for (let r = 0, o = e.length; r < o; ++r) {
                if (!c(e[r])) throw new Error("Arr.flatten item " + r + " was not an array, input: " + e);
                y.apply(t, e[r])
            }
            return t
        })(x(e, t)),
        ...
        Y = Q,
        ee = (g(q), g("iOS"), g(z), g(K), g(Z), g(G), g(H), g(J), (e, t, r) => {
            const o = B.browsers(),
                n = B.oses(),
                s = t.bind((e => ((e, t) => ((e, t) => {
                    for (let r = 0; r < e.length; r++) {
    ...
    const de = e => t => (e => e.dom.nodeType)(t) === e,
        ...
        pe = (e, t, r) => {
            ((e, t, r) => {
                if (!(i(r) || l(r) || d(r))) throw console.error("Invalid call to Attribute.set. Key ", t, ":: Value ", r, ":: Element ", e), new Error("Attribute value was not simple");
                e.setAttribute(t, r + "")
            })(e.dom, t, r)
        },
        ve = (e, t) => {
    ...
    function(e) {
        e.ListSchema = "ListSchema", e.SubstitutionSchema = "SubstitionSchema"
    }(Le || (Le = {})),
    function(e) {
        e.InsertUnorderedList = "InsertUnorderedList", e.InsertOrderedList = "InsertOrderedList", e.InsertDefinitionList = "InsertDefinitionList"
    }(Re || (Re = {})),
    function(e) {
    ...
    const _e = e => {
            var t, r;
            t = Ae(e.getBody()), r = "tox-cursor-format-painter", Se(t) ? t.dom.classList.add(r) : ((e, t) => {
                ((e, t, r) => {
        ...
        De = e => {
            ...
            return (e => {
                ...
                var r
            })(Ae(t)).fold((() => r.body.contains(t)), (o = De, n = Be, e => o(n(e))));
            var o, n
        },
        Ie = (e, t, r) => {
            let o = e.dom;
        ...
        Ke = (e, t, r) => {
            const o = e.formatter,
                ...
                a = (i = r.formatName, S(["formatpainter_borderstyle", "formatpainter_bordercolor", "formatpainter_backgroundcolor"], i));
            var i;
        ...
        Ze = e => {
            const t = e.selection,
                ...
                a = n.length && !((e, t) => {
                    const r = e => Fe(e, t);
                    return (o = je(Ae(e.getStart()), $e, r), n = je(Ae(e.getEnd()), $e, r), s = (e, t) => Fe(e, t), o.isSome() && n.isSome() ? v.some(s(o.getOrDie(), n.getOrDie())) : v.none()).getOr(!1);
                    var o, n, s
                })(t, o);
        ...
        Je = ("formatpainter_ignored_formats", e => e.options.get("formatpainter_ignored_formats"));
    const Qe = (e, t) => {
            return "class" === t ? (e => Se(e) ? (e => {
                ...
                return r
            })(e) : we(e))(e).filter((e => !/^(mce-.*)/.test(e))).join(" ") : (r = e, o = t, v.from(ve(r, o))).getOr("");
            var r, o
        },
        Xe = e => ((e, t) => {
            const r = {},
        ...
        et = (e, t) => {
            ...
            return O(x(r, Ae), (t => O(Ye(e, t), (r => ((e, t, r) => {
                return (o = e.get(t), ((e, t) => 0 < e.length ? v.some(e[0]) : v.none())(o)).bind((e => ((e, t) => {
                    const r = We(e, "styles").map((e => {
                            return r = t, o = Xe(e), ie(o, ((e, t) => ({
            ...
            t.addCommand("mceToggleFormatPainter", (() => {
                ((t, r) => {
                    r.get() === Ce.Application ? Pe(t, r) : ((t, r) => {
                        const o = oe(),
                            n = e(!1);
                        _e(t), r.set(Ce.Application), Oe(t, !0), t.execCommand("mceRetrieveFormats");
                        const s = () => {
                            ...
                            i = e => {
                                r.get() === Ce.Application && ("touchcancel" === e.type && o.os.isAndroid() ? t.once("contextmenu", s) : n.get() ? s() : t.once("selectionchange", s)), m()
                            },
                            c = e => {
                        ...
                        t.on("click", a), t.on("touchstart touchmove", l), t.on("touchend touchcancel", i), t.on("keydown", c);
                        const m = () => {
                            t.off("click", a), t.off("touchstart touchmove", l), t.off("touchend touchcancel", i), t.off("keydown", c)
                        }
                    })(t, r)
                })(t, r)
                ...
                t.undoManager.transact((() => {
                    ((e, t) => {
                        ((e, t) => {
                            e.formatter.remove("formatpainter_removeformat"), t === Te.Table && ((t, r) => {
                                for (let r = 0, n = t.length; r < n; r++) o = t[r], e.formatter.remove(o);
                                var o
                            })(["formatpainter_borderstyle", "formatpainter_bordercolor", "formatpainter_backgroundcolor"]), Ze(e) && e.execCommand("RemoveList")
                        })(e, t.context);
                        const r = (e => {
                            ...
                            return {
                                inline: !0,
                                table: r && n || o,
                                block: r || (s = e.selection, s.getSelectedBlocks().length > 1) || o
                            };
                            var s
                        })(e);
                        t.schemas.forEach((t => {
    ...
    tinymce.PluginManager.add("formatpainter", (t => {
        if (((e, t) => !!e && -1 === ((e, t) => {
                ...
                return 0 !== s ? s : 0
            })((e => n((e => [e.majorVersion, e.minorVersion].join(".").split(".").slice(0, 3).join("."))(e)))(e), n(t)))(tinymce, "6.0.0")) return void window.console.error("The format painter plugin requires at least version 6.0.0 of TinyMCE.");
        ...
        (e => {
            ...
            e.ui.registry.addToggleButton("formatpainter", {
                ...
                onSetup: t => {
                    ...
                    return e.on("FormatPainterToggle", r), () => e.off("FormatPainterToggle", r)
                }
            })
        })(t), ((e, t) => {
            e.ui.registry.addToggleMenuItem("formatpainter", {
                ...
                onSetup: r => {
                    ...
                    return r.setActive(t.get() === Ce.Application), e.on("FormatPainterToggle", o), () => e.off("FormatPainterToggle", o)
                }
            })
        })(t, o), (e => {
